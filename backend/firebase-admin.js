...
//
// This targets the koorazone-e59a7 Firebase project (separate from hraifi-59736,
// which belongs to the unrelated artisans app in backend/). Generate the key from
// Firebase Console > koorazone-e59a7 project > Project Settings > Service Accounts.
...
function loadServiceAccount() {
  ...
  if (!raw) {
    throw new Error(
      ...
      'Firebase Console (koorazone-e59a7) > Project Settings > Service Accounts, and set its full ' +
